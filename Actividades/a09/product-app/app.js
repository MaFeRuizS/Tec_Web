...
$(document).ready(function () {
    ...
    function listarProductos() {
        $.get("http://localhost/tec_web/actividades/a09/product-app/backend/index.php/product", function (data) {
    ...
    $("#search").on("input", function () {
        let search = $(this).val();
        $.get("http://localhost/tec_web/actividades/a09/product-app/backend/index.php/product?search=", { search: search }, function (data) {
            let productos = JSON.parse(data);
    ...
    $('#name').on('keyup', function() {
        ...
        if (nombre) {
            $.ajax({
                url: "http://localhost/tec_web/actividades/a09/product-app/backend/index.php/product", 
                method: 'GET',
                data: { search: nombre },
    ...
    $('#product-form').submit(e => {
        ...
        const url = edit ? "http://localhost/tec_web/actividades/a09/product-app/backend/index.php/product" : 'http://localhost/tec_web/actividades/a09/product-app/backend/index.php/product-edit';
    ...
    $(document).on("click", ".product-delete", function () {
        if (confirm("¿De verdad deseas eliminar el Producto?")) {
            ...
            $.ajax({
                url: "http://localhost/tec_web/actividades/a09/product-app/backend/product-delete", // una nueva ruta o misma que 'product'
                method: 'DELETE',
    ...
    $(document).on('click', '.product-item', function() {
        ...
        $.post("http://localhost/tec_web/actividades/a09/product-app/backend/index.php/product?id=", { id }, function(response) {
            console.log('Respuesta del servidor:', response);  
